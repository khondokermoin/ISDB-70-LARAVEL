                        ...
                        <div class="col-xl-3 col-lg-4">
                            <div class="card">
                                ...
                                <div class="custom-accordion">
                                    <div class="card-body border-top">
                                        <div>
                                            <h5 class="font-size-14 mb-0"><a href="#collapseExample1" class="text-reset d-block" data-bs-toggle="collapse">Discount <i class="mdi mdi-minus float-end accor-plus-icon"></i></a></h5>
                                    ...
                                    <div class="card-body border-top">
                                        <div>
                                            <h5 class="font-size-14 mb-0"><a href="#collapseExample2" class="text-reset d-block" data-bs-toggle="collapse">Size <i class="mdi mdi-minus float-end accor-plus-icon"></i></a></h5>
                                    ...
                                    <div class="card-body border-top">
                                        <div>
                                            <h5 class="font-size-14 mb-0"><a href="#collapseExample3" class="collapsed text-reset d-block" data-bs-toggle="collapse">Customer Rating <i class="mdi mdi-minus float-end accor-plus-icon"></i></a></h5>
                                            ...
                                            <div class="col-xl-4 col-sm-6">
                                                <div class="product-box">
                                                    ...
                                                    <div class="text-center">
                                                        ...
                                                        <h5 class="font-size-15"><a href="#" class="text-reset">Full sleeve T-shirt</a></h5>
                                            ...
                                            <div class="col-xl-4 col-sm-6">
                                                <div class="product-box">
                                                    ...
                                                    <div class="text-center">
                                                        ...
                                                        <h5 class="font-size-15"><a href="#" class="text-reset">Half sleeve T-shirt </a></h5>
                                            ...
                                            <div class="col-xl-4 col-sm-6">
                                                <div class="product-box">
                                                    ...
                                                    <div class="text-center">
                                                        ...
                                                        <h5 class="font-size-15"><a href="#" class="text-reset">Hoodie (Green)</a></h5>
