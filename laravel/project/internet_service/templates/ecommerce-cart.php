                                        ...
                                        <table class="table table-centered mb-0 table-nowrap">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <h5 class="font-size-14 text-truncate"><a href="ecommerce-product-detail.php" class="text-reset">Full sleeve T-shirt</a></h5>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <h5 class="font-size-14 text-truncate"><a href="ecommerce-product-detail.php" class="text-reset">Half sleeve T-shirt</a></h5>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <h5 class="font-size-14 text-truncate"><a href="ecommerce-product-detail.php" class="text-reset">Hoodie (Green)</a></h5>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <h5 class="font-size-14 text-truncate"><a href="ecommerce-product-detail.php" class="text-reset">Hoodie (Gray)</a></h5>
