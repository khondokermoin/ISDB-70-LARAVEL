                                ...
                                <div class="card-body">
                                    ...
                                    <div id="accordion" class="custom-accordion">
                                        <div class="card mb-1 shadow-none">
                                            <a href="#collapseOne" class="text-reset" data-bs-toggle="collapse" aria-expanded="true" aria-controls="collapseOne">
                                        ...
                                        <div class="card mb-1 shadow-none">
                                            <a href="#collapseTwo" class="text-reset collapsed" data-bs-toggle="collapse" aria-expanded="false" aria-controls="collapseTwo">
                                        ...
                                        <div class="card mb-0 shadow-none">
                                            <a href="#collapseThree" class="text-reset collapsed" data-bs-toggle="collapse" aria-expanded="false" aria-controls="collapseThree">
