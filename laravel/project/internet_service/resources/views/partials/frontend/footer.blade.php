<footer class="bg-amberDark text-gray-300 pt-16 pb-8">
    <div class="container mx-auto max-w-6xl px-4">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8 border-b border-gray-700 pb-12 mb-8">
            ...
            <div>
                ...
                <ul class="space-y-2 text-sm">
                    <li><a href="{{ route('home.internet') }}" class="hover:text-amberRed transition">Home Internet</a></li>
                    <li><a href="{{ route('corporate') }}" class="hover:text-amberRed transition">Corporate Internet</a></li>
                    <li><a href="{{ route('coverage') }}" class="hover:text-amberRed transition">Coverage Area</a></li>
                    <li><a href="{{ route('iptsp') }}" class="hover:text-amberRed transition">IPTSP</a></li>
                </ul>
            </div>
            ...
            <div>
                ...
                <ul class="space-y-2 text-sm">
                    ...
                    <li><a href="{{ route('support') }}" class="hover:text-amberRed transition">Contact</a></li>
                </ul>
            </div>
        ...
        <div class="flex flex-col md:flex-row justify-between items-center text-sm text-gray-500">
            <p>&copy; {{ date('Y') }} Amar IT. All Rights Reserved.</p>
