...
// line chart
let islinechart = document.getElementById('lineChart');

islinechart.setAttribute("width", islinechart.parentElement.offsetWidth);

new Chart(islinechart, {
    type: 'line',
    data: {
...
// pie chart
let ispiechart = document.getElementById('pie');

new Chart(ispiechart, {
    type: 'pie',
    data: {
        labels: [
            "Desktops",
...
// donut
const isdoughnutchart = document.getElementById('doughnut');
...
// polarArea chart
const ispolarAreachart = document.getElementById('polarArea');
new Chart(ispolarAreachart, {
    type: 'polarArea',
    data: {
        datasets: [{
            data: [
...
// radar chart
const isradarchart = document.getElementById('radar');
new Chart(isradarchart, {
    type: 'radar',
    data: {
