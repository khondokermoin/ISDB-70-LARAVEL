    ...
    <div class="page-container">
        ...
        <div class="row row-cols-xxl-4 row-cols-md-2 row-cols-1">
            ...
            <div class="col">
                <div class="card">
                    <div class="card-body">
                        <h5 class="text-muted fs-13 text-uppercase" title="Monthly Revenue">Monthly Revenue</h5>
                        <div class="d-flex align-items-center gap-2 my-3">
                            <h3 class="mb-0">৳{{ number_format($billingStats['monthly_revenue'], 2) }}</h3>
                            <i class="ti ti-currency-taka ms-auto display-1 position-absolute opacity-25 text-muted widget-icon"></i>
                        </div>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="d-flex align-items-center gap-2 my-3">
                            ...
                            <i class="ti ti-receipt ms-auto display-1 position-absolute opacity-25 text-muted widget-icon"></i>
                        </div>
                        <p class="mb-0 text-muted">
            ...
            <div class="col">
                <div class="card">
                    <div class="card-body">
                        <h5 class="text-muted fs-13 text-uppercase" title="Active Subscriptions">Active Subscriptions</h5>
                        <div class="d-flex align-items-center gap-2 my-3">
                            <h3 class="mb-0">{{ $billingStats['active_subscriptions'] }}</h3>
                            <i class="ti ti-circle-check ms-auto display-1 position-absolute opacity-25 text-muted widget-icon"></i>
                        </div>
                        <p class="mb-0 text-muted">
                            <span class="text-warning me-2"><i class="ti ti-clock"></i> {{ $billingStats['expiring_soon'] }}</span>
            ...
            <div class="col">
                <div class="card">
                    <div class="card-body">
                        <h5 class="text-muted fs-13 text-uppercase" title="Available Plans">Available Plans</h5>
                        <div class="d-flex align-items-center gap-2 my-3">
                            <h3 class="mb-0">{{ $billingStats['total_plans'] }}</h3>
                            <i class="ti ti-package ms-auto display-1 position-absolute opacity-25 text-muted widget-icon"></i>
                        </div>
                        <p class="mb-0 text-muted">
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ route('superadmin.subscriptions.index', ['status' => 'active']) }}" class="btn btn-sm btn-outline-primary">View All</a>
                    </div>
                        ...
                        <table class="table table-hover mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><span class="badge bg-{{ $sub->daysRemaining() <= 3 ? 'danger' : 'warning' }}">{{ $sub->daysRemaining() }}d</span></td>
                                    <td>
                                        <a href="{{ route('superadmin.subscriptions.show', $sub->id) }}" class="btn btn-sm btn-outline-info">
                                            <i class="ti ti-eye"></i>
                                        </a>
                                    </td>
                                </tr>
                                @empty
                                <tr>
                                    <td colspan="5" class="text-center py-3 text-muted">No subscriptions expiring soon.</td>
                                </tr>
                                @endforelse
                            </tbody>
                        </table>
