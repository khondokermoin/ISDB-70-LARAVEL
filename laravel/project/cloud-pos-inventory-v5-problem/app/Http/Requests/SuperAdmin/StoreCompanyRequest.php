...
class StoreCompanyRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            // Include 'inactive' since the create form exposes that option
            ...
            // Admin user fields — required only when an existing user_id is NOT provided
            'admin_name' => 'required_without:user_id|string|max:255',
            'admin_email' => 'required_without:user_id|email|unique:users,email',
            'admin_password' => 'required_without:user_id|string|min:8|confirmed',
        ];
    }
