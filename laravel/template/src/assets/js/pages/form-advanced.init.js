...
!function ($) {
    ...
    AdvancedForm.prototype.init = function () {
      ...
      function formatState(state) {
        ...
        let baseUrl = "/assets/images/flags/select2";
        let $state = $(
  ...
  $(function () {
    ...
    let $date = $('.docs-date');
    let $container = $('.docs-datepicker-container');
    let $trigger = $('.docs-datepicker-trigger');
    let options = {
      show: function (e) {
    ...
    $('.docs-options, .docs-toggles').on('change', function (e) {
      ...
      let value = target.type === 'checkbox' ? target.checked : $target.val();
      let $optionContainer;
