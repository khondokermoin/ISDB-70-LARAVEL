...
!function($) {
    ...
    FlotChart.prototype.randomData = function() {
      ...
      while (this.$realData.length < totalPoints) {
        ...
        let prev = this.$realData.length > 0 ? this.$realData[this.$realData.length - 1] : 50,
    ...
    FlotChart.prototype.createDonutGraph = function(selector, labels, datas, colors) {
        ...
        FlotChart.prototype.init = function() {
          //plot graph data
          let desktops = [[0, 50], [1, 130], [2, 80], [3, 70], [4, 180], [5, 105], [6, 250]];
          let laptops = [[0, 80], [1, 100], [2,60], [3, 120], [4, 140], [5, 100], [6, 105]];
          let tablets = [[0, 20], [1, 80], [2, 70], [3, 140], [4, 250], [5, 80], [6, 200]];
          let plabels = ["Desktops","Laptops","Tablets"];
          let pcolors = ['#f0f1f4', '#5664d2', '#1cbb8c'];
          let borderColor = 'rgba(166, 176, 207, 0.1)';
          let bgColor = 'transparent';
          this.createPlotGraph("#website-stats", desktops, laptops, tablets, plabels, pcolors, borderColor, bgColor);

          //Pie graph data
          let pielabels = ["Desktops","Laptops","Tablets"];
          let datas = [20,30, 15];
          let colors = ['#5664d2','#1cbb8c', "#ebeff2"];
          this.createPieGraph("#pie-chart #pie-chart-container", pielabels , datas, colors);


            //real time data representation
            let plot = this.createRealTimeGraph('#flotRealTime', this.randomData() , ['#1cbb8c']);
            plot.draw();
            let $this = this;
            function updatePlot() {
          ...
          let donutlabels = ["Desktops","Laptops","Tablets"];
          let donutdatas = [29,20, 18];
          let donutcolors = ['#f0f1f4', '#5664d2', '#1cbb8c'];
